...
export type CraftCardType = 'subtle' | 'small' | 'square' | 'wide' | 'large'

export type CraftCardFontStyle = 'regular' | 'serif' | 'rounded'
...
export type CraftTextBlock = CraftBaseBlock &
  HasSubblocks & {
    type: 'textBlock'
...
export type CraftTextBlockConfig = HasBasePropertiesInsert &
  HasSubblocksInsert & {
...
export type TextStyle = 'title' | 'subtitle' | 'heading' | 'strong' | 'body' | 'caption' | 'card' | 'page'
